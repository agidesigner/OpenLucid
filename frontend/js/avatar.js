...
document.addEventListener('alpine:init', () => {
  ...
  document.querySelectorAll('#avatar-mount').forEach(mount => {
    mount.outerHTML = `
<div x-data="avatarMenu()" x-init="init()" @click.outside="open = false" class="relative owner-only">
  ...
  <div x-show="open" x-cloak
    ...
    <a href="/account.html" class="owner-only flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
    ...
    <a href="/setting.html" class="owner-only flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
    ...
    <div class="owner-only border-t border-gray-100 mt-1 pt-1">
